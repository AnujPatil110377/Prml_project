...
# Load model
model_path ='C:/Users/91798/Downloads/sentiment-analysis-with-deep-neural-networks-main/sentiment-analysis-with-deep-neural-networks-main/c1_lstm_model_acc_0.864.h5'
pretrained_lstm_model = load_model(model_path)

# Loading
with open('C:/Users/91798/Downloads/sentiment-analysis-with-deep-neural-networks-main/sentiment-analysis-with-deep-neural-networks-main') as f:
    data = json.load(f)
...
@app.route('/')
def home():
    return render_template('C:/Users/91798/Downloads/sentiment-analysis-with-deep-neural-networks-main/sentiment-analysis-with-deep-neural-networks-main/templates/index.html')
